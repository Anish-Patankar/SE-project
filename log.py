...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(30, 10, 250, 41))
        ...
        self.label_5.setGeometry(QtCore.QRect(30, 190, 350, 16))
